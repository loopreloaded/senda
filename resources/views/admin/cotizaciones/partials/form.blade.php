    ...
    <tbody id="items-table">
        ...
        <tr>
            <td>
                ...
                @endphp
                <select name="items[{{ $index }}][id_pedido_cot]" 
                        class="form-control select-pedido no-select2" 
        ...
        <tr>
            <td>
                <select name="items[0][id_pedido_cot]" 
                        class="form-control select-pedido no-select2"
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        debounceTimer = setTimeout(async () => {
            ...
            clientes.forEach(cli => {
                ...
                btn.onclick = function() {
                    ...
                    document.querySelectorAll('.select-pedido').forEach(sel => {
                        poblarSelectPedidos(sel, cli.id);
                    });
                };
    ...
    if (initialCliId) {
        ...
        document.querySelectorAll('.select-pedido').forEach(sel => {
            poblarSelectPedidos(sel, initialCliId);
        });
    }
});
</script>
